...
void Transactions::setloggedUserId(int newloggedUserId)
{
   ...
   void Transactions::setTransactionId(int newTransactionId)
    ...
    Transactions Transactions::giveDataOfNewTransaction()
    {
       Transactions transaction;
       UserManager userManager;

       transaction.setloggedUserId(userManager.getLoggedUserId());
       ...
       while (yOrN !='Y' && yOrN != 'N')
{
 ...
 bool Transactions::isDateCorrect(string Date)
    {
...
int Transactions::getNumberOfDaysOfMonth(int year, int month)
{
