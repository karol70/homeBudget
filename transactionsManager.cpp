...
void TransactionManager::showTransactions(Transactions transaction)
{
    ...
    cout << "Amount: " << transaction.getAmount ()<< endl<<endl;
...
void TransactionManager::showBalance(int dateFrom, int dateTo)
{
    ...
    cout << "Sum of expenses: " << expensesAmount<<endl;
    cout << "BALANCE: "<<  incomesAmount - expensesAmount  <<endl<<endl;
